...
# COVID-19 source data is licensed under Creative Commons Licence: CC BY-NC-SA 3.0 IGO
...
# UN population source data is licensed under Creative Commons Licence: CC BY 3.0 IGO: http://creativecommons.org/licenses/by/3.0/igo/
...
plot_cases <- plotting(country_data, country_data$facetby, country_data$date_reported, country_data$cases_per_capita, "Date Reported", "Cases / million", "Covid-19 cases per million for UK vs. America")
plot_deaths <- plotting(country_data, country_data$facetby, country_data$date_reported, country_data$deaths_per_capita, "Date Reported", "Deaths / million", "Covid-19 deaths per million for UK vs. America")
